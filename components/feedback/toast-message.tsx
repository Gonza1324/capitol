...
const messages: Record<string, string> = {
  ...
  task_occurrences_generated: "Ocurrencias de tarea generadas.",
  recurrence_no_new_occurrences: "No hay ocurrencias nuevas para generar en ese rango.",
  ...
  google_calendar_connected: "Google Calendar conectado correctamente.",
  google_calendar_disconnected: "Google Calendar desconectado.",
  google_calendar_synced: "Eventos de Calendar sincronizados.",
  google_calendar_not_configured: "Faltan credenciales de Google Calendar.",
  google_calendar_not_connected: "Primero conecta Google Calendar.",
  google_calendar_reconnect_required: "Necesitamos reconectar Google Calendar.",
  google_calendar_event_linked: "Evento asociado al cliente.",
  internal_calendar_event_created: "Evento creado correctamente.",
  internal_calendar_event_updated: "Evento actualizado correctamente.",
  internal_calendar_event_completed: "Evento marcado como completado.",
  internal_calendar_event_cancelled: "Evento cancelado.",
  internal_calendar_event_postponed: "Evento pospuesto.",
  internal_calendar_occurrences_generated: "Ocurrencias de calendario generadas.",
  notification_read: "Notificacion marcada como leida.",
  notifications_read: "Notificaciones marcadas como leidas.",
  notifications_refreshed: "Recordatorios actualizados.",
  notifications_refreshed_empty: "No hay recordatorios nuevos.",
